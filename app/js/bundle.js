...
(function setupWeeks() {
  let numOfWeeks = $('.days').length; //Template literals for info that goes inside of $('.num-box')
  ...
  const close_day = `<div class="close-day entypo-cancel"></div>`; //Add html for each row or week
