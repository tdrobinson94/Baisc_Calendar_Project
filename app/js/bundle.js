...
const {
  MONTHS
} = require('./utilities/months.constant.js');

let clock = new Date();
let month = clock.getMonth();
let year = clock.getFullYear();
var day = clock.getDate(); //Template literals for info that goes inside of $('.num-box')
...
let close_day = `<div class="close-day entypo-down-open"></div>`;
console.log("Begin your javascript"); // Creates the contents of each calendar box

(function setupWeeks() {
  let numOfBoxes = $('.num-box').length + 1; //Add html for each row or week
...
$('.month-selector').change(); //============= Scroll Months functionality ==================//
...
$('.prev').click(function () {
  ...
  function scrollDay() {
    if ($('.num-box').hasClass('selected-day')) {
      console.log('change');
      $('body, html').animate({
        scrollTop: $('.selected-day').offset().top - 150
      }, 500);
    }
  }
